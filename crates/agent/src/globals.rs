...
use aeroshield_common::types::{AP, AttackTarget, Client};
...
pub static CAPTURE_DIR: &str = "/var/lib/aeroshield";

pub static LIVE_SCAN_PATH: &str = "/var/lib/aeroshield/live_scan";
pub static OLD_SCAN_PATH: &str = "/var/lib/aeroshield/old_scan";
...
/// projection ([`aeroshield_common::types::AttackState`]), `stop` asks the injection
